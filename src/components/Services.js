...
const Services = () => {
  ...
  const handleLoad = () => {
    console.log("Did you click it?"); // Check if this line appears in the console
    setIsLoaded(true);
  };
  return (
    <div className={"absolute mt-20 mx-auto left-0 right-0 text-slate-200  -z-10"} >
